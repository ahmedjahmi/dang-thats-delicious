...
// total list of mapOptions in google maps docs
var mapOptions = {
    center: { lat: 43.2, lng: -79.8 },
    zoom: 12
};

// crown heights lat=40.6 & lng=-73.9;
...
function loadPlaces(map) {
    ...
    _axios2.default.get('/api/stores/near?lat=' + lat + '&lng=' + lng).then(function (res) {
        ...
        var markers = places.map(function (place) {
            // the data comes back from our db
            // is in the form of [lng, lat]. google uses [lat, lng].
